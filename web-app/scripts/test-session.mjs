...
for (const name of ["study", "session", "local-workspace"]) {
...
const result = spawnSync(process.execPath, ["--test", "tests/session.test.cjs", "tests/local-workspace.test.cjs"], { stdio: "inherit" });
