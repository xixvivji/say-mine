...
for (const name of ["study", "session", "local-workspace", "library", "practice"]) {
...
const result = spawnSync(process.execPath, ["--test", "tests/session.test.cjs", "tests/local-workspace.test.cjs", "tests/library.test.cjs", "tests/practice.test.cjs"], { stdio: "inherit" });
